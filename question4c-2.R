...
sh <- sh %>% 
  gather(pKey, Patientdays, c("Patientdays_Y2015-16", "Patientdays_Y2016-17")) %>% 
  gather(sKey, Separations, c("Separations_Y2015-16", "Separations_Y2016-17")) %>%
  filter(pKey == "Patiendays_Y2015-16", sKey == "Separations_Y2016-17") %>%
  filter(pKey == "Patiendays_Y2015-16", sKey == "Separations_Y2016-17") %>%
